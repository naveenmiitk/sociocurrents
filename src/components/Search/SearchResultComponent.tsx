          ...
          if (item.slug?.current === undefined || item.slug?.current === null)
            ...
            return (
              <div key={index} className="">
                ...
                <Link
                  href={
                    getBaseHref(item._type)?.concat(`${item?.slug?.current}`)!
                  }
                >
                  <div className="mx-2 border-b-2 border-neutral-200 py-4 flex items-center justify-between pr-2 hover:bg-yellow-400 rounded-lg my-2">
