...
const SubFooter = () => {
  return (
    <div className='border-t-2 border-neutral-700 bg-gradient-to-tr from-yellow-50 via-slate-50 to-red-50 w-full lg:w-full lg:mx-auto'>
    <div className='flex flex-col md:flex-row lg:w-[70vw] justify-between items-center mx-auto border-0 border-red-500'>
       ...
       <div className='flex max-w-[50%] sm:max-w-[40%] lg:max-w-[30%] mx-10 my-6 border-0 border-red-500 p-2'>
           <h1 className={cn('text-2xl md:text-3xl lg:text-4xl xl:text-4xl text-red-700 max-w-xl tracking-[0.1em]', anton.className)}>Socio Currents Made in India With ❤️ & Tea.</h1>
       </div>
       ...
       <div className='flex flex-col items-center justify-center border-0 border-red-500 pt-0'>
           ...
           <h1 className='text-xl font-semibold'>Proud Founder of Indian Sociology</h1>
       </div> 
       </div>
