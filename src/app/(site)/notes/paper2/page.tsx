...
import { topicsPaper1, topicsPaper2 } from '@/lib/type/staticData';
import { Metadata } from 'next';


const query = groq`
*[_type =='notes' && details match 'Paper2']{
  ...,
...
export const metadata: Metadata = {
  title: "Notes (Paper-2) | Sociology Optional UPSC",
  description:
...
const NotesHomePage = async () => {
  ...
  // const a = JSON.stringify(topicsPaper2);
  // console.log(a);
